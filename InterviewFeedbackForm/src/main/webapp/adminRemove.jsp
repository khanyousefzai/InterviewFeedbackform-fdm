  ...
  <div class="main_container margin_auto">
    <nav class="side_nav">
      ...
      <div class="nav_interactable">
        <span>Admin: Remove User</span>
      </div>
    </nav>

    <div class="home_container">
      <nav class="displayFlexRow " id="home_nav">
        <h1 class="alignselfCenter" id="homeNavTitle">Admin: Remove User</h1>
      ...
      <div class = "admin_container bordered top_item">
        <h1 class="tittle">Remove Panel</h1>
        <div id = "errContainer">
        ...
        <div class="option_container bordered">
          ...
          <form  method = "post" action = "/removeuser">
            <div class="field_wrapper">
              <label class = "field_Label">Remove User</label>
              <input type="text" id = "username" name="username" class="field ui-autocomplete-input">
            </div>

            <input type = "submit" value = "Remove" class="button submit" onclick="return confirm('Do you want to delete the user?')">
          </form>


          <form  method = "post" action = "/removeclient">
            <div class="field_wrapper">
              <label class = "field_Label">Remove Client</label>
              <input type="text" id = "client" name="clientName" class="field ui-autocomplete-input">
            </div>

            <input type = "submit" value = "Remove" class="button submit" onclick="return confirm('Do you want to remove the client?')">
